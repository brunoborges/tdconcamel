...
public class TDCOnCamelRoute extends RouteBuilder {
                ...
                .process(exchange -> {
                    ...
                    if (body.startsWith("search ")) {
                        ...
                        exchange.getContext().addRoutes(new RouteBuilder() {
                            @Override
                            public void configure() throws Exception {
                                from("twitter://streaming/filter?type=event&keywords=" +
                                        query)
                                        .to("seda:images")
                                        .routeId("twitterStreaming");
                            }
    ...
    private void setupTwitterComponent(TwitterComponent tc) {
        ...
        try (InputStream is =
                     TDCOnCamelRoute.class.getResourceAsStream("/app.properties")) {
            ...
            if (accessTokenSecret == null) {
                accessTokenSecret =
                        configProperties.getProperty("twitter.accessTokenSecret");
            }
